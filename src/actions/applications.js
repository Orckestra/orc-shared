...
export const getApplications = () => makeOrcApiAction(GET_APPLICATIONS, buildUrl(["my", "applications"]));
...
export const getMyApplication = () => makeOrcApiAction(GET_MY_APPLICATION, buildUrl(["my", "application"]));
