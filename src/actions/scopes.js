...
export const getScopes = () => makeOrcApiAction(GET_SCOPES, buildUrl(["my", "scope", OVERTURE_MODULE, "tree"], {}));
...
export const getDefaultScope = () => makeOrcApiAction(GET_MY_SCOPE, buildUrl(["my", "scope", OVERTURE_MODULE]));
